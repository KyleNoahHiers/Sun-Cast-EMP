...
Returns: A pandas DataFrame containing the original weather prediction data along with a new column, Solar Prediction, which contains the predicted solar production.
...
Returns: A pandas DataFrame containing the original load prediction data along with a new column, Load Prediction, which contains the predicted load demand.
